...
function emp()
{	
	if(jobcodeedit1.t9.value != ""){
		  var re = /^-?\d\d*$/;
		  if (!re.test(jobcodeedit1.t9.value)) { 
			    alert("Please enter Integer number only");
			    jobcodeedit1.t9.focus() ;
			    return false;
			} 
		  if(jobcodeedit1.t9.value.length != 10){
...
<form name="jobcodeedit1" action="matriedits.jsp" method="post" onsubmit="return emp();">
  <TBODY>
  <TR>
    ...
    bgColor=#ffffff>
            <p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <font color="#A87DFF">Enter Contact No</font><font color="red">*</font> 
