...
function emp()
{
	if(jobcodeedit1.t1.value != ""){
		  var re = /^-?\d\d*$/;
		  if (!re.test(jobcodeedit1.t1.value)) { 
			    alert("Please enter Integer number only");
			    jobcodeedit1.t1.focus() ;
			    return false;
			} }
}
</script>
...
<form name="jobcodeedit1" action="cinemaedits.jsp" method="post" onsubmit="return emp();">
  <TBODY>
  <TR>
    ...
    bgColor=#ffffff>
            <p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <font color="#A87DFF">Enter Theater No</font><font color="red">*</font> 
                <input type="text" name="t1" size="20" tabindex="1" required>
            </p>
          </TD></TR>
        <TR>
          <TD vAlign=top width=689 
