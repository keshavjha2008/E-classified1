...
function emp()
{
	if(jobcodeedit1.textfield1.value != ""){
		  var re = /^-?\d\d*$/;
		  if (!re.test(jobcodeedit1.textfield1.value)) { 
			    alert("Please enter Integer number only");
			    jobcodeedit1.textfield1.focus() ;
			    return false;
			} }
}
	</script>
...
<form name="jobcodeedit1" action="jobedits.jsp" method="post" onsubmit="return emp();">
  <TBODY>
  <TR>
    ...
    bgColor=#ffffff>
            <p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <font color="#A87DFF">Enter Job Code </font><font color="red">*</font> 
