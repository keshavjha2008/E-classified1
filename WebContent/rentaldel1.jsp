...
function emp()
{
	if(hnodelete.textfield1.value != ""){
		  var re = /^-?\d\d*$/;
		  if (!re.test(hnodelete.textfield1.value)) { 
			    alert("Please enter Integer number only");
			    hnodelete.textfield1.focus() ;
			    return false;
			} }
}
</script>
...
<form name="hnodelete" action="rentaldel.jsp" method="post" onsubmit="return emp();">
          ...
          <p align="center">   <font color="orange" size="5">U
            ...
            <tr>
            <td>
             <font color="green">Enter House No</font><font color="red">*</font> 
            </td>
            <td> 
