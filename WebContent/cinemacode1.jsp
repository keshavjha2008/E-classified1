...
function emp()
{
	if(theaternodelete.textfield1.value != ""){
		  var re = /^-?\d\d*$/;
		  if (!re.test(theaternodelete.textfield1.value)) { 
			    alert("Please enter Integer number only");
			    theaternodelete.textfield1.focus() ;
			    return false;
			} }
}
...
<form name="theaternodelete" action="cinemacode.jsp" method="post" onsubmit="return emp();">
          ...
          <p align="center">   <font color="orange" size="5">U
            ...
            <tr>
            <td>
             <font color="green">Enter Theater No</font><font color="red">*</font> 
            </td>
            <td> 
