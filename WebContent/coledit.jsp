...
<form name="jobcodeedit1" action="coledits.jsp" method="post">
  <TBODY>
  <TR>
    ...
    bgColor=#ffffff>
            <p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <font color="#A87DFF">Enter College Id</font><font color="red">*</font> 
                <input type="text" name="cid" size="20" tabindex="1" required>
            </p>
          </TD></TR>
        <TR>
          <TD vAlign=top width=689 
