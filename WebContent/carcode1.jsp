...
function emp()
{
	if(carcodedelete.textfield1.value != ""){
		  var re = /^-?\d\d*$/;
		  if (!re.test(carcodedelete.textfield1.value)) { 
			    alert("Please enter Integer number only");
			    carcodedelete.textfield1.focus() ;
			    return false;
			} }
}
...
<form name="carcodedelete" action="carcode.jsp" method="post" onsubmit="return emp();">
          ...
          <p align="center">   <font color="orange" size="5">U
            ...
            <tr>
            <td>
             <font color="green">Enter Car Code</font><font color="red">*</font> 
            </td>
            <td> 
