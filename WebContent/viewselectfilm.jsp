...
String mname="";
 ...
 out.println("<h2 align='center'><b><font color='green' size='5'>Language Name:</font> </b><font color='orange' size='4'>"+languagename+"</font></h2>"); */
  ...
  rs=st.executeQuery("select * from sunday_cinema");
        %>
        
        
<p align="center"><font color="orange" size="5">Available Information</font></i></b>
 </p>  
...
<td width="109" height="55">
  <p align="center"><b>Theater NO</b></p>
</td>
...
<td width="109" height="55">
           <p align="center">
	   <b><%=rs.getString(1)%></b></p>

	  </td>	
           <td width="109" height="55">
           <p align="center">
	   <b><%=rs.getString(2)%></b></p>

	  </td>
	  <td width="109" height="55">  <p align="center">
 
	   <b><%=rs.getString(3)%></b></p>
	  </td>
	  <td width="109" height="55">  <p align="center">
 
	   <b><%=rs.getString(4)%></b></p>
	  </td>
	   <td width="109" height="55"><p align="center">  
	   <b><%=rs.getString(5)%></p> 
