...
<% 
 	...
 	ps=con.prepareStatement("update wheels set  carmodel=?,costofcar=?,usedsofor=?,contactper=?,contactno=?,contactaddress=?,discription=? where  carcode="+st1);
    ...
    bgColor=#ffffff>&nbsp;</TD></TR>
        <TR>
          <TD vAlign=top width=771 
    bgColor=#ffffff>
            <p align="center"><b><font color="green" size="4"> Car Details Updated Successfully</font></b>
          </TD></TR>
        <TR>
          <TD vAlign=top width=771 
    bgColor=#ffffff>&nbsp;
